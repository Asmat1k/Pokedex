declare module '*.module.scss' {
  // данная декларация модулей нужна для импорта css в ts как объекта
...
declare module '*.svg' {
  // данные декларации нужна для работы с svg как с реакт компонентом (с подсказываниям по пропсам и т.д.)
